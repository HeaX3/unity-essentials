...
namespace Essentials
{
    public static class RectTransformExtensions
    {
        ...
        /// <summary>
        /// Make this rect transform cover the entire area of its parent by setting anchor min to (0, 0), anchor max to (1, 1), and all offsets to (0, 0).
        /// </summary>
        ...
        public static void AttachTopLeft(this RectTransform rectTransform)
        {
            rectTransform.AnchorTopLeft();
            rectTransform.pivot = new Vector2(0, 1);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachTop(this RectTransform rectTransform)
        {
            rectTransform.AnchorTop();
            rectTransform.pivot = new Vector2(0.5f, 1);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachTopRight(this RectTransform rectTransform)
        {
            rectTransform.AnchorTopRight();
            rectTransform.pivot = new Vector2(1, 1);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachRight(this RectTransform rectTransform)
        {
            rectTransform.AnchorRight();
            rectTransform.pivot = new Vector2(1, 0.5f);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachBottomRight(this RectTransform rectTransform)
        {
            rectTransform.AnchorBottomRight();
            rectTransform.pivot = new Vector2(1, 0);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachBottom(this RectTransform rectTransform)
        {
            rectTransform.AnchorBottom();
            rectTransform.pivot = new Vector2(0.5f, 0);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachBottomLeft(this RectTransform rectTransform)
        {
            rectTransform.AnchorBottomLeft();
            rectTransform.pivot = new Vector2(0, 0);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AttachLeft(this RectTransform rectTransform)
        {
            rectTransform.AnchorLeft();
            rectTransform.pivot = new Vector2(0, 0.5f);
            rectTransform.offsetMin = Vector2.zero;
            rectTransform.offsetMax = Vector2.zero;
        }

        public static void AnchorTopLeft(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.up;
            rectTransform.anchorMax = Vector2.up;
        }

        public static void AnchorTop(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.up;
            rectTransform.anchorMax = Vector2.one;
        }

        public static void AnchorTopRight(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.one;
            rectTransform.anchorMax = Vector2.one;
        }

        public static void AnchorRight(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.right;
            rectTransform.anchorMax = Vector2.one;
        }

        public static void AnchorBottomRight(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.right;
            rectTransform.anchorMax = Vector2.right;
        }

        public static void AnchorBottom(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.zero;
            rectTransform.anchorMax = Vector2.right;
        }

        public static void AnchorBottomLeft(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.zero;
            rectTransform.anchorMax = Vector2.zero;
        }

        public static void AnchorLeft(this RectTransform rectTransform)
        {
            rectTransform.anchorMin = Vector2.zero;
            rectTransform.anchorMax = Vector2.up;
        }
