...
namespace Essentials
{
    ...
    {
        public static void Fill(this MeshRenderer renderer, Transform root, Bounds wrappingBounds,
        ...
        private static Bounds CalculateBounds(MeshRenderer renderer, MeshPosition position)
        {
